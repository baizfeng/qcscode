...
if __name__ == "__main__":
    try:
        # 1.解析XML文件
        # xmlpath = r"D:\DATA\QCS\SST\AHI8\AHI8-_AGRI--_N_DISK_1407E_L2-_SST-_MULT_NOM_20181210020000_20181210021000_4000M_V0001_OISST.xml"
        xmlpath=sys.argv[1]
